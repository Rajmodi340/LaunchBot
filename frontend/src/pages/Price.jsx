...
function Price() {
    ...
    const [loading,setloading]=useState(null) // store the plan key while processing
  ...
  return (
    <div className='relative min-h-screen overflow-hidden bg-[#050505] text-white px-6 pt-16 pb-24'>
      ...
      <button className='relative z-10 mb-8 flex items-center gap-2 text-sm text-zinc-400 hover:text-white transition'onClick={()=>navigate("/")}>
        <ArrowLeft size={14}></ArrowLeft>Back
      </button>
      <motion.div
...
<div className="flex items-center gap-2 mb-8">
    <Coins size={18} className='text-yellow-400'></Coins>
        <span className='font-semibolds'>{p.credits} Credits</span>
